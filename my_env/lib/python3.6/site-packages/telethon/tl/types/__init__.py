...
class Channel(TLObject):
    ...
    # noinspection PyShadowingBuiltins
    def __init__(self, id: int, title: str, photo: 'TypeChatPhoto', date: Optional[datetime], version: int, creator: Optional[bool]=None, left: Optional[bool]=None, broadcast: Optional[bool]=None, verified: Optional[bool]=None, megagroup: Optional[bool]=None, restricted: Optional[bool]=None, signatures: Optional[bool]=None, min: Optional[bool]=None, scam: Optional[bool]=None, has_link: Optional[bool]=None, access_hash: Optional[int]=None, username: Optional[str]=None, restriction_reason: Optional[str]=None, admin_rights: Optional['TypeChatAdminRights']=None, banned_rights: Optional['TypeChatBannedRights']=None, default_banned_rights: Optional['TypeChatBannedRights']=None, participants_count: Optional[int]=None):
        """
...
class ChannelFull(TLObject):
    ...
    def __bytes__(self):
        ...
        assert ((self.online_count or self.online_count is not None) and (self.linked_chat_id or self.linked_chat_id is not None)) or ((self.online_count is None or self.online_count is False) and (self.linked_chat_id is None or self.linked_chat_id is False)), 'online_count, linked_chat_id parameters must all be False-y (like None) or all me True-y'
...
class ChatFull(TLObject):
    ...
    # noinspection PyShadowingBuiltins
    def __init__(self, id: int, about: str, participants: 'TypeChatParticipants', notify_settings: 'TypePeerNotifySettings', exported_invite: 'TypeExportedChatInvite', can_set_username: Optional[bool]=None, chat_photo: Optional['TypePhoto']=None, bot_info: Optional[List['TypeBotInfo']]=None, pinned_msg_id: Optional[int]=None, folder_id: Optional[int]=None):
        """
        Constructor for ChatFull: Instance of either ChatFull, ChannelFull.
        """
        self.id = id
    ...
    def from_reader(cls, reader):
        ...
        if flags & 2048:
            ...
            _folder_id = None
        return cls(id=_id, about=_about, participants=_participants, notify_settings=_notify_settings, exported_invite=_exported_invite, can_set_username=_can_set_username, chat_photo=_chat_photo, bot_info=_bot_info, pinned_msg_id=_pinned_msg_id, folder_id=_folder_id)
...
class UserFull(TLObject):
    CONSTRUCTOR_ID = 0x745559cc
    SUBCLASS_OF_ID = 0x1f4661b9

    def __init__(self, user: 'TypeUser', link: 'TypeLink', notify_settings: 'TypePeerNotifySettings', common_chats_count: int, blocked: Optional[bool]=None, phone_calls_available: Optional[bool]=None, phone_calls_private: Optional[bool]=None, can_pin_message: Optional[bool]=None, about: Optional[str]=None, profile_photo: Optional['TypePhoto']=None, bot_info: Optional['TypeBotInfo']=None, pinned_msg_id: Optional[int]=None, folder_id: Optional[int]=None):
        """
    ...
    def __bytes__(self):
        return b''.join((
            b'\xccYUt',
            struct.pack('<I', (0 if self.blocked is None or self.blocked is False else 1) | (0 if self.phone_calls_available is None or self.phone_calls_available is False else 16) | (0 if self.phone_calls_private is None or self.phone_calls_private is False else 32) | (0 if self.can_pin_message is None or self.can_pin_message is False else 128) | (0 if self.about is None or self.about is False else 2) | (0 if self.profile_photo is None or self.profile_photo is False else 4) | (0 if self.bot_info is None or self.bot_info is False else 8) | (0 if self.pinned_msg_id is None or self.pinned_msg_id is False else 64) | (0 if self.folder_id is None or self.folder_id is False else 2048)),
            bytes(self.user),
...
TypeContactLink = Union[ContactLinkUnknown,ContactLinkNone,ContactLinkContact]
...
TypeInputPrivacyKey = Union[InputPrivacyKeyStatusTimestamp,InputPrivacyKeyChatInvite,InputPrivacyKeyPhoneCall,InputPrivacyKeyPhoneP2P,InputPrivacyKeyForwards,InputPrivacyKeyProfilePhoto,InputPrivacyKeyPhoneNumber]
...
TypePrivacyKey = Union[PrivacyKeyStatusTimestamp,PrivacyKeyChatInvite,PrivacyKeyPhoneCall,PrivacyKeyPhoneP2P,PrivacyKeyForwards,PrivacyKeyProfilePhoto,PrivacyKeyPhoneNumber]
