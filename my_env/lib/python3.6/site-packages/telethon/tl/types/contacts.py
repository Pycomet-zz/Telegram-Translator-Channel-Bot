...
class Blocked(TLObject):
    ...
    def __init__(self, blocked: List['TypeContactBlocked'], users: List['TypeUser']):
        """
...
class BlockedSlice(TLObject):
    ...
    def __init__(self, count: int, blocked: List['TypeContactBlocked'], users: List['TypeUser']):
        """
        Constructor for contacts.Blocked: Instance of either Blocked, BlockedSlice.
        """
        self.count = count
...
class Link(TLObject):
    ...
    def __init__(self, my_link: 'TypeContactLink', foreign_link: 'TypeContactLink', user: 'TypeUser'):
        """
